let counter = 0;
const target = 98; // Maqsad raqam
const speed = 50; // O'zgarish tezligi (ms)
let started = false; // Hisoblash faqat bir marta boshlanishi uchun

const updateCounter = () => {
  if (counter < target) {
    counter++;
    document.getElementById("counter").innerHTML = counter + "<span>%</span>";
    setTimeout(updateCounter, speed);
  }
};

// Intersection Observer bilan sanashni faqat element ko'ringanda boshlaymiz
const observer = new IntersectionObserver((entries) => {
  if (entries[0].isIntersecting && !started) {
    started = true; // Faqat bir marta ishga tushishi uchun
    updateCounter();
  }
});
...
let counter1 = 0;
const target1 = 100; // Maqsad raqam
const speed1 = 50; // O'zgarish tezligi (ms)
let started1 = false; // Hisoblash faqat bir marta boshlanishi uchun

const updateCounter1 = () => {
  if (counter1 < target1) {
    counter1++;
    document.getElementById("counter1").innerHTML =
      counter1 + `k<span class="second-section-bottom-div-h1-span1">+</span>`;
...
const observer1 = new IntersectionObserver((entries) => {
  if (entries[0].isIntersecting && !started1) {
    started1 = true; // Faqat bir marta ishga tushishi uchun
    updateCounter1();
  }
});

observer1.observe(document.getElementById("counter1"));

let counter2 = 0;
const target2 = 100; // Maqsad raqam
const speed2 = 50; // O'zgarish tezligi (ms)
let started2 = false; // Hisoblash faqat bir marta boshlanishi uchun

const updateCounter2 = () => {
  if (counter2 < target2) {
    counter2++;
    document.getElementById("counter2").innerHTML =
      counter2 + `k<span class="second-section-bottom-div-h1-span2">+</span>`;
    setTimeout(updateCounter2, speed1);
  }
};
...
const observer2 = new IntersectionObserver((entries) => {
  if (entries[0].isIntersecting && !started2) {
    started2 = true; // Faqat bir marta ishga tushishi uchun
    updateCounter2();
  }
});

observer2.observe(document.getElementById("counter2"));

let counter3 = 0;
const target3 = 33; // Maqsad raqam
const speed3 = 33; // O'zgarish tezligi (ms)
let started3 = false; // Hisoblash faqat bir marta boshlanishi uchun

const updateCounter3 = () => {
  if (counter3 < target3) {
    counter3++;
    document.getElementById("counter3").innerHTML = counter3 + `<span>%</span>`;
    setTimeout(updateCounter3, speed1);
  }
};

// Intersection Observer bilan sanashni faqat element ko'ringanda boshlaymiz
const observer3 = new IntersectionObserver((entries) => {
  if (entries[0].isIntersecting && !started3) {
    started3 = true; // Faqat bir marta ishga tushishi uchun
    updateCounter3();
  }
});

observer3.observe(document.getElementById("counter3"));
